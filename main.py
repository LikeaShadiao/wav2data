...
# 训练部分的代码，两个参数：保存模型的标识符runName，数据生成器实例（调用时调用实例dg）
    ...
    def enhancement_single(self, noisy_f, output_f = './enhance_s.wav', plot = True):
        ...
        if plot:
            ...
            #save_path = '/home/showaker/tf_DPCRN/DPCRN_DNS3/figure'
            #os.makedirs(save_path, exist_ok=True)
            #save_file_0 = os.path.join(save_path, 'figure0.png') 
            #plt.savefig(save_file_0, bbox_inches='tight')
            ...
            #save_file_1 = os.path.join(save_path, 'figure1.png')
            #plt.savefig(save_file_1, bbox_inches='tight') 
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_dir", type=str, default = './testly_left.wav', help = 'the floder of noisy speech or a single file')
    parser.add_argument("--output_dir", type=str, default = './enhancedly_left.wav', help = 'the floder of enhanced speech or a single file')
